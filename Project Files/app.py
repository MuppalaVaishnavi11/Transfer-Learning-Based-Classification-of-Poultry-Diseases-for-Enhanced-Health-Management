...
treatments = {
    ...
    "New Castle": "Isolate birds and apply ND vaccine immediately.",
...
def output():
    if request.method == 'POST':
        ...
        labels = ['Coccidiosis', 'Healthy', 'New Castle', 'Salmonella']
        prediction = labels[pred_index]

        print("Predicted Label:", prediction)
        return render_template("predict_page.html", predict=prediction, treatment=treatments[prediction])
